#pragma once    //main.cpp에서 여러 헤더파일을 불러올때 include<~>횟수를 줄여줌
...
public:
    ...
    //생성자
    SmartHome(string owner, int temperature, int humidity, bool security) { //매개변수(Parameter)랑 인수(Argument)의 차이 구별
        this->owner = owner;
